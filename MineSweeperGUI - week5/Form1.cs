    ...
    public partial class Form1 : Form
    {
        ...
        private void BtnSquareClickEh(object sender, EventArgs e)
        {
            ...
            if (keepflag == true)
            {
                ...
                if (setflag == false) {
                        ...
                        score = (score - score /12) + (score - score / 13);
                        frmWinOrLose loss = new frmWinOrLose(false,score);
                        loss.Visible = true;
                        }
                        ...
                        score += (_board.Grid[row, col].BombRefrence *100);
                        }
        ...
        private void CeckForWin()
        {
            if (lblLose.Visible == false)
            {
                ...
                {
                    score = score / 10;
                    frmWinOrLose win = new frmWinOrLose(true,score);
                    win.Visible= true;
                }            
